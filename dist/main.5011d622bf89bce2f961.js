...
var store = new __WEBPACK_IMPORTED_MODULE_4_vuex__["a" /* default */].Store({
    ...
    getters: {
        num: function num(state) {
            // 只要goods发生变化 num就会跟着改变    num依赖goods
    ...
    mutations: {
        // mutations 是官方推荐的修改state中数据的途径
        getBannerList: function getBannerList(state, obj) {
            state.bannerList = obj;
        },
        getKbList: function getKbList(state, obj) {
            state.kbList = obj;
        },
